      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        {unlocked && (
          <div className="text-center mt-4 space-y-4">
            ...
            <p className="text-lg">Amor, nunca he sido de escribir palabras de amor... Tampoco había regalado flores ni esperado con tantas ansias a hablar con alguien, siempre pensé que esas cosas no eran para mi, que eran simplemente para otro tipo de persona.
